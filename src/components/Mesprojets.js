...
const Mesprojets = () => {
    return (
        ...
        <section className="container mes-projets-page">
            <div className="row justify-content-around text-center">
                ...
                <div className="col-lg-5 right-project-box">
                    <div className="project-box">
            ...
            <div className="mt-5 mb-4 text-center text-uppercase lowerLink">
                <a href="https://github.com/remi-turini?tab=repositories" className="text-reset "><span>Découvrir tout les projets</span></a>
            </div>
        </section>
        </>
    )
